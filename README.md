...
![Preview](https://github.com/user-attachments/assets/6de2b950-1437-4ce0-849e-02efbe5bd8c0)
...
manifest:
  remotes:
    ...
    - name: joegoldin #new entry
      url-base: https://github.com/joegoldin #new entry
  projects:
    - name: zmk
      remote: zmkfirmware
      revision: main
